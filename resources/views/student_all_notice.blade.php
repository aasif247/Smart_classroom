                                        ...
                                        <div class="col-lg-12">
                                            <div class="panel panel-inverse panel-fill">
                                                ...
                                                <div class="panel-body"> 
                                                    ...
                                                    $trimstring = substr($string, 0, 470). "<a style='color:white;text-decoration:underline;font-size:18px;margin-left:10px;' href='/view-notice/$allnotice->id' >Read More ...</a>";
                                                    } else {
                                                    $trimstring = $string;
                                                    }
                                                    echo $trimstring;
